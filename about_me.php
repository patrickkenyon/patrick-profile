...
function placeholderData($newdata,$olddata,$submit) {
    if (isset($submit)) {
        echo $newdata;
    } else {
        echo $olddata;
...
<body>
    ...
    <form method="post" action="about_me.php">
        <input type="text" name="bio_title" value="<?php echo placeholderData($_POST["bio_title"], $about_me_data[0]["bio_title"], $_POST["submit"]) ?>"> Bio title<br/>
